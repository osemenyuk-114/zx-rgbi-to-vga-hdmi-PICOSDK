...
#ifdef HIRES_ENABLE
#define OUTPUT_MENU_ITEM_COUNT 3 // mode, scanlines, back
#else
#define OUTPUT_MENU_ITEM_COUNT 4 // mode, scanlines, buffering, back
#endif

    for (int i = 0; i < OUTPUT_MENU_ITEM_COUNT; i++)
    {
        uint8_t row = OSD_MENU_START_ROW + i;
